...
[working-directory: 'go']
go-print: go-build
    ./resume-renderer --input ../{{filename}} --output ../output/resume-print.html --pdf ../output/resume.pdf --since 2011-05-01 --no-testimonials
...
serve directory="docs":
    uv -m http.server --directory {{directory}}
